...
name = "detector"
base.initialize(name,"localhost", 49226, "DetectorRESTService/Detector")
...
class Detector:
    ...
    def set_detectorsetting(self, body):
        ...
        '''
        uri = "/{}/Setting".format(self.detector)
        return base.run(name, uri, "POST", body)
