...
from ._base import Forwarder, AbstractWidget
from .._enums import *

W = typing.TypeVar("W", bound=widgets.QWidget)

__all__ = ["LabelledWidget", "DoubleLabelledWidget", "PALFunction", "OrderedGroup"]
...
class PALFunction(widgets.QWidget, abc.ABC, metaclass=AbstractWidget):
    """
    ...
    def __init__(self, name: str, enabled=False, **params: widgets.QWidget):
