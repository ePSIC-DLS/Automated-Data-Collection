...
from ._validators import ValidatedWidget, Spinbox, V
from .._enums import *
from .... import validation

VW = typing.TypeVar("VW", bound=ValidatedWidget)

__all__ = ["XDControl", "SizeControl", "ScanPattern", "ScanPatternGroup", "Counter"]
...
class ScanPattern(widgets.QWidget):
    ...
    def __init__(self, name: str, shortcut: str = None, live=False, **options: ValidatedWidget):
        ...
        trigger.clicked.connect(lambda: blank.show() if not blank.isVisible() else None)
